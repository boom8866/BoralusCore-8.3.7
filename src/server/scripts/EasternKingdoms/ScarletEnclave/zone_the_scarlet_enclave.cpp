...
class playerScript_scarlet_enclave : public PlayerScript
{
public:
    playerScript_scarlet_enclave() : PlayerScript("playerScript_scarlet_enclave") { }
...
void AddSC_the_scarlet_enclave()
{
    ...
    new playerScript_scarlet_enclave();
}
