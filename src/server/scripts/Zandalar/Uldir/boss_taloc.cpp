...
{
    boss_taloc(Creature* creature) : BossAI(creature, DATA_BOSS_TALOC)
    {
    }
...
//287464
struct go_taloc_elevator : public GameObjectAI
{
    go_taloc_elevator(GameObject* go) : GameObjectAI(go) { }

    void Reset() override
    {
        //go->SetTransportState(GO_STATE_TRANSPORT_STOPPED);
    }
...
void AddSC_boss_taloc()
{
    ...
    RegisterGameObjectAI(go_taloc_elevator);
