...
class spell_warl_demonic_empowerment : public SpellScript
{
    ...
    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_warl_demonic_empowerment::HandleTargets, EFFECT_ALL, TARGET_UNIT_CASTER_AND_SUMMONS);
...
public:
    ...
    class spell_warl_healthstone_heal_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_warl_healthstone_heal_AuraScript);
        ...
        void Register() override
        {
            DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_warl_healthstone_heal_AuraScript::CalculateAmount, EFFECT_1, SPELL_AURA_PERIODIC_HEAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_warl_healthstone_heal_AuraScript();
    }
