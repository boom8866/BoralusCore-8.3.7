    ...
    public:
        ...
        class spell_general_nazgrim_aftershock_SpellScript : public SpellScript
        {
            ...
            void FilterTargets(std::list<WorldObject*>& targets)
            {
                ...
                Position endPos = GetCaster()->GetPosition();
            ...
            void Register()
            {
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_general_nazgrim_aftershock_SpellScript::FilterTargets, EFFECT_0, TARGET_DIR_FRONT);
                OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_general_nazgrim_aftershock_SpellScript::FilterTargets, EFFECT_1, TARGET_DIR_FRONT);
            }
